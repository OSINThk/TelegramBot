...
public class ReportService {
    ...
    public static void main(String[] args) {
        ...
        map.add("report[lat]", "27.6780809");
        map.add("report[long]", "85.3778235");
        map.add("report[notes]", "New Product");
        map.add("report[product_detail_attributes][0][_destroy]", "false");
        map.add("report[product_detail_attributes][0][product_id]", "2");
        map.add("report[product_detail_attributes][0][scarcity]", "3");
        map.add("report[product_detail_attributes][0][price]", "2");
        map.add("report[product_detail_attributes][0][notes]", "The new product upload");
